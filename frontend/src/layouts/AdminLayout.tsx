...
const navItems: NavItem[] = [
  ...
  { to: '/app/timetable', label: 'Thời khóa biểu', icon: 'calendar_month' },
  { to: '/app/parent-menu', label: 'Thực đơn hôm nay', icon: 'lunch_dining',},
  { to: '/app/teacher-menu', label: 'Tạo thực đơn', icon: 'menu_book' },
  { to: '/app/teacher-leave', label: 'Đơn xin nghỉ', icon: 'description' },
  { to: '/app/principal-leave', label: 'Quản lý nghỉ phép', icon: 'fact_check' },
  { to: '/app/teacher-extra-subjects', label: 'Đăng ký môn ngoài', icon: 'checklist' },
  { to: '/app/parent-leave', label: 'Xin nghỉ phép', icon: 'event_busy' },
  { to: '/app/parent-extra-subjects', label: 'Môn học của con', icon: 'school' },
  { to: '/app/food-declaration', label: 'Khai báo thực đơn', icon: 'restaurant' },
